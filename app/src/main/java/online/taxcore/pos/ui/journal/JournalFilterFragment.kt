...
class JournalFilterFragment : Fragment() {
    ...
    private fun takeSearchField() {
        with(JournalManager) {
            ...
            transactionType = getTType()
            invoiceType = getItype()
    ...
    private fun getItype() =
        when (journalFilterInvoiceTypeSpinner.selectedItem.toString()) {
            "None" -> ""
            else -> journalFilterInvoiceTypeSpinner.selectedItem.toString()
        }

    private fun getTType() =
        when (journalFilterTransactionTypeSpinner.selectedItem.toString()) {
            "None" -> ""
            else -> journalFilterTransactionTypeSpinner.selectedItem.toString()
        }
